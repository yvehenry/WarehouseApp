...
import ca.mcgill.ecse.wareflow.javafx.fxml.controllers.*;
...
public class AssignmentPageController {
  private static WareFlow wflow = WareFlowApplication.getWareFlow();

  @FXML private TextField assignOrderIDTextField, assignEmployeeUsernameTextField, noteDescriptionTextField, noteDateTextField;
  @FXML private Button assignOrderButton;
  @FXML private Button startChangeOrderButton;
  @FXML private Button completeChangeOrderButton;
  @FXML private Button approveChangeOrderButton;
  @FXML private Button disapproveChangeOrderButton;
  @FXML private ChoiceBox<String> timeEstimateChoiceBox, priorityChoiceBox, requiresApprovalChoiceBox, employeeUsernameChoiceBox;
